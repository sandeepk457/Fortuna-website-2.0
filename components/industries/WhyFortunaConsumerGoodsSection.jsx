...
const features = [
  {
    ...
    description:
      "Digitize procurement, production, inventory and warehouse operations through one intelligent consumer goods platform.",
    icon: Boxes,
    color: "red",
  },
  {
    ...
    description:
      "Predict consumer demand, seasonal trends and inventory requirements using AI-powered forecasting and analytics.",
    icon: BrainCircuit,
    color: "blue",
  },
  {
    ...
    description:
      "Optimize transportation, warehouse replenishment and distribution planning to improve delivery performance.",
    icon: Truck,
    color: "red",
  },
  {
    ...
    description:
      "Ensure continuous product availability across retail stores through intelligent replenishment and inventory visibility.",
    icon: Store,
    color: "blue",
  },
  {
    ...
    description:
      "Connect ERP, CRM, WMS, distributors, retailers and third-party logistics providers through secure enterprise integration.",
    icon: Network,
    color: "red",
  },
  {
    ...
    description:
      "Protect consumer goods operations with enterprise-grade security, audit trails and role-based access management.",
    icon: ShieldCheck,
    color: "blue",
  },
];

export default function WhyFortunaConsumerGoodsSection() {
  return (
    <section className="relative overflow-hidden py-32">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('/images/industries/Grid/FMCG1.png')",
        }}
      />
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h2 className="mt-6 text-5xl md:text-6xl font-black leading-tight">
            ...
            <span className="text-white">
              ...
              Why Consumer Goods Leaders Choose
            ...
            <span className="block text-white">
              ...
              Digital Consumer Goods Platform
          ...
          <p className="mt-10 text-xl leading-9 text-white/90 max-w-4xl mx-auto">
            ...
            Fortuna empowers Consumer Goods organizations with intelligent
            inventory management, AI-powered demand forecasting,
            distribution optimization, retail replenishment and
